...
<div className="flex flex-col items-center mt-[30px] space-y-[30px] w-full px-4">
  <div className="border border-gray-400 rounded-[40px] flex flex-row items-center justify-center h-auto md:h-[200px] w-full sm:w-[350px] md:w-[400px] p-6">
    <div className="h-[80px] w-[80px] bg-black rounded-full flex items-center justify-center shrink-0">
      <img
        src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Ficon%2F21.png&w=256&q=75"
        className="h-10 w-10 object-contain"
      />
    </div>
    <div className="ml-[20px] sm:ml-[30px]">
      <p className="text-black dark:text-white font-bold text-lg sm:text-xl md:text-2xl">
        Online Food Delivery
      </p>
      <p className="text-gray-600 dark:text-white mt-2 text-sm sm:text-base">
